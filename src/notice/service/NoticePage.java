...
public class NoticePage {
	...
	private List<NoticeVO> content;	//화면에 출력할 게시글 목록 10
	...
	public String toString() {
		return "ArticlePage의 전체 게시글 수=" + total + ", 현재 페이지=" + currentPage + ", 총페이지 수="
				+ totalPages + ", 시작페이지=" + startPage + ", 마지막페이지=" + endPage + ", 해당페이지의 게시글=" + content+"]";
	}
}
